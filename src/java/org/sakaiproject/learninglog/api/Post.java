...
import org.sakaiproject.learninglog.cover.SakaiProxyCover;
...
public class Post implements Entity
{
	...
	{
		return LearningLogManager.REFERENCE_ROOT + Entity.SEPARATOR + "post" + Entity.SEPARATOR + id;
	}
	...
	{
		String toolId = SakaiProxyCover.getLearningLogToolId(siteId);
		return SakaiProxyCover.getServerUrl() + "/portal/directtool/" + toolId + "?state=post&postId=" + getId();
	}
